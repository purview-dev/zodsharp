...
public sealed class ZodProblemDetailsOptions
{
	...
	/// using the error's <see cref="ZodSharp.Core.ValidationError.Parameters"/>. Defaults to <c>true</c>.
	/// </summary>
	...
	/// </summary>
	public Func<ImmutableArray<ZodSharp.Core.ValidationError>, int>? StatusCodeSelector { get; set; }
