...
partial class ZodSchemaGenerator
{
	...
	)
	{
		...
		registrationWriter.Line(
			$"[assembly: global::{TypeLibrary.ZodSharp.ZodSchemaGeneratedAttribute.MetadataFullName}(typeof({outputContext.ZodSchema.TargetType.AsTypeReference()}))]"
		);
		...
		foreach (var property in schema.Properties)
		{
			...
			writer.Field(
				...
				)
				{
					IsStatic = true,
					IsReadOnly = true,
					Initializer = TypeLibrary.System.Collections.Immutable.ImmutableArray.StaticMember(
	...
	static void GenerateValidationHelpers(CodeWriter writer, CancellationToken cancellationToken)
	{
		...
		var immutableArrayType = TypeLibrary.System.Collections.Immutable.ImmutableArray;
